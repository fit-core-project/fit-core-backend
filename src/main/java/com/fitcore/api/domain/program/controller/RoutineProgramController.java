...
public class RoutineProgramController {
    ...
    public ResponseEntity<ProgramDetailResponse> activateProgram(@PathVariable String programId) {
        return ResponseEntity.ok(programService.activateProgram(programId));
    }
}
